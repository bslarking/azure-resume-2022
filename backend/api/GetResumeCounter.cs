...
namespace Company.Function
{
    public static class GetResumeCounter
    {
        ...
        public static HttpResponseMessage Run(
            ...
            // This binding allows us to retrieve an item of Id 1, connect to the db via the AzureResumeConnectionString, look for the item in the container called counter,
            // which is in the AsumeResume database
